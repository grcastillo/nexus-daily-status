  ...
  teams: [
    {
      ...
      bullets: [
        ...
        'Partial-Blocked: Snowflake → S3 → SQL Server pipeline not yet done — blocking final progress on the data layer. A global concern, not just inventory. Escalated to Eric Livergood, Chris Ostrowski, and Tom Wonneberger',
      ],
    },
    {
      name: 'Dex',
